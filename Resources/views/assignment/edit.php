            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="<?php echo baseurl('/assignment/update'); ?>" method="post">
                            <h3 class="text-center text-primary">TAREA <?php echo $valid_id; ?></h3>
                            <div class="form-group d-none">
                                <label for="id" class="text-primary">Id:</label><br>
                                <input <?php echo ($edit == 1) ? '' : 'disabled' ?> type="text" name="id" id="id" class="form-control" value="<?php echo $assignment['id']; ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="progress_id" class="text-primary">Estatus:</label>
                                <select class="form-control" id="progress_id" name="progress_id" <?php echo ($edit == 1) ? '' : 'disabled' ?>>
